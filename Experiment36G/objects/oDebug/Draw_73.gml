...
if(instance_exists(oPlayer))
{
	...
	if(instance_exists(oDisplayManager)) draw_text(__view_get( e__VW.XView, 0 ) + 4 + (8 * 11) - 15, __view_get( e__VW.YView, 0 ) + 250, string_hash_to_newline(string(oDisplayManager.ideal_height)));
	if(instance_exists(oDisplayManager)) draw_text(__view_get( e__VW.XView, 0 ) + 4 + (8 * 11) - 15, __view_get( e__VW.YView, 0 ) + 350, string_hash_to_newline(string(oDisplayManager.ideal_width)));
	if(instance_exists(oDisplayManager)) draw_text(__view_get( e__VW.XView, 0 ) + 4 + (8 * 11) - 15, __view_get( e__VW.YView, 0 ) + 450, string_hash_to_newline(string(oDisplayManager.zoom)));
